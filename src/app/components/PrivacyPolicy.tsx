				...
				>
					...
					<div className="mb-12 p-6 rounded-lg bg-gradient-to-br from-[#FF6B35]/10 to-[#DC2626]/10 border-2 border-[#FF6B35]/30">
						<p className="text-lg text-[#E5E7EB]">
							<span className="font-semibold text-[#FF6B35]">Summary:</span>{" "}
							Project Phoenix is a privacy-focused, offline-first app. Your
							workout data stays on your device. We do not collect, transmit, or
					...
					<div className="space-y-8">
						...
						<section>
							<h2 className="text-2xl mb-4 text-[#FF6B35]">
							...
							<ul className="space-y-2 text-[#E5E7EB] ml-6">
								...
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">Custom Routines:</span>{" "}
										Workout routines you create within the App
									</span>
								</li>
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										...
										settings such as weight unit preference (kg/lb), theme, and
										display options
									</span>
								</li>
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">Gamification Data:</span>{" "}
						...
						<section>
							...
							<p className="text-[#E5E7EB] leading-relaxed mb-4">
								All your data is stored locally on your device using secure,
								encrypted storage mechanisms provided by the operating system.
							...
							<ul className="space-y-2 text-[#E5E7EB] ml-6">
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">No Cloud Sync:</span> Your
								...
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">No Account Required:</span>{" "}
								...
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">No External Servers:</span>{" "}
						...
						<section>
							...
							<p className="text-[#E5E7EB] leading-relaxed mb-3">
								...
								advertising, or tracking services. We do not use:
							</p>
							<ul className="space-y-2 text-[#E5E7EB] ml-6">
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
						...
						<section>
							...
							<p className="text-[#E5E7EB] leading-relaxed">
								...
								Since all data is stored locally on your device and never
								transmitted externally, there is no data to share with third
								parties.
							</p>
						</section>
							...
							<ul className="space-y-2 text-[#E5E7EB] ml-6 mb-4">
								<li className="flex items-start gap-2">
									...
									<span>
										...
										is visible within the App's history and analytics screens
									</span>
								</li>
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										...
										delete individual workouts, routines, or clear all App data
								...
								<li className="flex items-start gap-2">
									<span className="text-[#FF6B35] mt-1">•</span>
									<span>
										<span className="font-semibold">Portability:</span> Your
										data remains on your device and can be backed up using your
										device's standard backup mechanisms
									</span>
								</li>
							</ul>
							<p className="text-[#E5E7EB] leading-relaxed">
								To delete all App data, you can uninstall the App or clear the
								App's data through your device's application settings.
							</p>
						</section>
								...
								<li className="flex items-start gap-2">
									...
									<span>
										...
										<a
											...
											className="text-[#FF6B35] hover:text-[#F59E0B] underline"
										>
