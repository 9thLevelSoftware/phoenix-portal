...
import { Activity, Watch, Dumbbell, Smartphone } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
...
import type { ExternalActivity, IntegrationProvider } from '@/lib/integrations/types';
...
export function ExternalActivityList({ activities }: ExternalActivityListProps) {
  ...
  if (activities.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        ...
        <p className="text-xs mt-1">Connect a provider above to start syncing activities.</p>
      </div>
    );
  }
