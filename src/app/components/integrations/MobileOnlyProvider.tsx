...
import type { IntegrationProvider, UserIntegration } from '@/lib/integrations/types';
...
export function MobileOnlyProvider({ provider, integration }: MobileOnlyProviderProps) {
