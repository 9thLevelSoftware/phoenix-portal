					...
					<div className="space-y-8">
						...
						<section>
							...
							<p className="text-secondary-foreground leading-relaxed">
								...
								a community rescue project for Vitruvian Trainer workout
							...
							<p className="text-secondary-foreground leading-relaxed mt-4">
								...
								is not affiliated with or endorsed by Vitruvian.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-secondary-foreground leading-relaxed">
								...
								the property of 9th Level Software LLC. The Vitruvian Trainer
								name and trademarks belong to their respective owners.
							</p>
							<p className="text-secondary-foreground leading-relaxed mt-4">
