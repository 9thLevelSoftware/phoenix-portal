...
const sizeConfig = {
	...
	lg: {
		className: "w-24 h-24",
		src: logo192,
		srcSet: `${logo96} 96w, ${logo192} 192w, ${logo512} 512w`,
		sizes: "96px",
	},
	xl: {
		className:
			"w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[32rem] lg:h-[32rem]",
		src: logo512,
		srcSet: `${logo192} 192w, ${logo512} 512w`,
		sizes:
			"(min-width: 1024px) 512px, (min-width: 768px) 384px, (min-width: 640px) 320px, 256px",
	},
};
