...
export function ExportSection() {
  const { user } = useAuth();
  const { data: workouts, isLoading: workoutsLoading } = useQuery(workoutListOptions(user?.id ?? ''));
  const { data: records, isLoading: recordsLoading } = useQuery(personalRecordsOptions(user?.id ?? ''));
