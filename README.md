...
Web companion dashboard for [Project Phoenix](https://github.com/DasBluEyedDevil/Project-Phoenix-MP) — the community rescue project keeping Phoenix fitness machine workout machines alive after company bankruptcy. View workouts, build routines and training cycles, analyze biomechanics, and replay 50Hz session telemetry synced from the Kotlin Multiplatform mobile app.
...
*This project exists because of the Phoenix fitness machine community's refusal to let great hardware die.*
