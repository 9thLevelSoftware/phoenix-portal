 ...
 */
export function createEmptyRoutineFixture(userId?: string): NestedRoutineFixture {
 ...
 */
export function createMaxValueSessionFixture(userId?: string): WorkoutSessionRow {
 ...
 */
export function createMaxWeightSetFixture(exerciseId?: string, userId?: string) {
 ...
 */
export function createMaxRpgAttributesFixture(userId?: string): RpgAttributesRow {
 ...
 */
export function createMaxGamificationStatsFixture(userId?: string): GamificationStatsRow {
 ...
 */
export function createMinimalSessionFixture(userId?: string): WorkoutSessionRow {
  return createSessionFixture({
    user_id: userId,
    name: null,
    routine_name: null,
 ...
 */
export function createWeightBoundarySetFixtures(exerciseId?: string, userId?: string) {
 ...
 */
export function createAsymmetryBoundaryRepFixtures(setId?: string, userId?: string) {
 ...
 */
export function createVelocityBoundaryRepFixtures(setId?: string, userId?: string) {
  ...
  return Object.entries(VELOCITY_BOUNDARY_VALUES).map(([name, velocity]) =>
    createRepSummaryFixture({
      ...
      vbt_zone: zoneForVelocity(velocity) as "EXPLOSIVE" | "FAST" | "MODERATE" | "SLOW" | "GRIND",
    })
  );
}
 ...
 */
export function createEdgeCaseCollection(userId?: string): EdgeCaseFixtureCollection {
  return {
    ...
    unicodeSessions: Object.keys(UNICODE_TEST_STRINGS).map((variant) =>
      createUnicodeSessionFixture(variant as keyof typeof UNICODE_TEST_STRINGS, userId)
    ),
    unicodeRoutines: Object.keys(UNICODE_TEST_STRINGS).map((variant) =>
      createUnicodeRoutineFixture(variant as keyof typeof UNICODE_TEST_STRINGS, userId)
    ),
    ...
    asymmetryBoundaryReps: createAsymmetryBoundaryRepFixtures(undefined, userId),
