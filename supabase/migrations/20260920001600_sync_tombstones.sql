...
-- tombstones while routines and cycles are being removed. Tombstones recorded
-- while the account was live are purged by the account purge (PR 34) and by
-- 180-day retention (PR 31).
