-- Fix: routine_session_id is TEXT in workout_sessions, not UUID
-- The RPC function declared wrong return type, causing:
...
RETURNS TABLE (
    ...
    routine_name TEXT,
    workout_mode TEXT,
    routine_session_id TEXT,  -- Fixed: was UUID, actual column is TEXT
    notes TEXT,
