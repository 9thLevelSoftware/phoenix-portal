...
ON CONFLICT (id) DO UPDATE SET name=EXCLUDED.name, display_name=EXCLUDED.display_name, description=EXCLUDED.description, muscle_group=EXCLUDED.muscle_group, muscle_groups=EXCLUDED.muscle_groups, muscles=EXCLUDED.muscles, equipment=EXCLUDED.equipment, movement=EXCLUDED.movement, sidedness=EXCLUDED.sidedness, grip=EXCLUDED.grip, grip_width=EXCLUDED.grip_width, default_cable_config=EXCLUDED.default_cable_config, min_rep_range=EXCLUDED.min_rep_range, popularity=EXCLUDED.popularity, aliases=EXCLUDED.aliases, thumbnail_url=EXCLUDED.thumbnail_url, archived=EXCLUDED.archived, is_custom=EXCLUDED.is_custom, user_id=EXCLUDED.user_id, updated_at=NOW();
